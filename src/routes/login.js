...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    // 🚩 Added success log to confirm a successful login
    ...
    // 🚩 Improved error log for better debugging
    console.log('Failed to authenticate user:', error.response?.data || error.message); // 🚩
