...
const authMiddleware = auth({
  audience: 'https://activities-api',
  issuerBaseURL: `https://dev-7txjr4h7f68rlivl.us.auth0.com/`,
});
/* The issuerBaseURL in your code is part of the OAuth2 and JWT (JSON Web Token) authentication process. It tells your app where to verify tokens and get information about the authorization process. The value given is the url address which the domain of your Auth0 account: dev-7txjr4h7f68rlivl.us.auth0.com*/
